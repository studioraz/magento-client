...
exports.SalesTransactionRepositoryV1Api = void 0;
var runtime = __importStar(require("../runtime"));
var models_1 = require("../models");
/**
 *
 */
var SalesTransactionRepositoryV1Api = /** @class */ (function (_super) {
    __extends(SalesTransactionRepositoryV1Api, _super);
    function SalesTransactionRepositoryV1Api() {
     ...
     */
    SalesTransactionRepositoryV1Api.prototype.getV1TransactionsRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.SalesDataTransactionSearchResultInterfaceFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Lists transactions that match specified search criteria. This call returns an array of objects, but detailed information about each object’s attributes might not be included. See https://devdocs.magento.com/codelinks/attributes.html#TransactionRepositoryInterface to determine which call to use to get detailed information about all attributes for an object.
     */
    SalesTransactionRepositoryV1Api.prototype.getV1Transactions = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1TransactionsRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     */
    SalesTransactionRepositoryV1Api.prototype.getV1TransactionsIdRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, token, tokenString, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.request({
                            path: "/V1/transactions/{id}".replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters.id))),
                            method: 'GET',
                            headers: headerParameters,
                            query: queryParameters,
                        }, initOverrides)];
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.SalesDataTransactionInterfaceFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Loads a specified transaction.
     */
    SalesTransactionRepositoryV1Api.prototype.getV1TransactionsId = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1TransactionsIdRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
...
exports.SalesTransactionRepositoryV1Api = SalesTransactionRepositoryV1Api;
//# sourceMappingURL=SalesTransactionRepositoryV1Api.js.map