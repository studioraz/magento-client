...
exports.AsynchronousOperationsOperationRepositoryV1Api = void 0;
var runtime = __importStar(require("../runtime"));
var models_1 = require("../models");
/**
 *
 */
var AsynchronousOperationsOperationRepositoryV1Api = /** @class */ (function (_super) {
    __extends(AsynchronousOperationsOperationRepositoryV1Api, _super);
    function AsynchronousOperationsOperationRepositoryV1Api() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * Lists the bulk operation items that match specified search criteria.
     */
    AsynchronousOperationsOperationRepositoryV1Api.prototype.getV1BulkRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.AsynchronousOperationsDataOperationSearchResultsInterfaceFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Lists the bulk operation items that match specified search criteria.
     */
    AsynchronousOperationsOperationRepositoryV1Api.prototype.getV1Bulk = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1BulkRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
    ...
    return AsynchronousOperationsOperationRepositoryV1Api;
}(runtime.BaseAPI));
exports.AsynchronousOperationsOperationRepositoryV1Api = AsynchronousOperationsOperationRepositoryV1Api;
//# sourceMappingURL=AsynchronousOperationsOperationRepositoryV1Api.js.map