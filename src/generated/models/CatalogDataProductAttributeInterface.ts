...
import {
    EavDataAttributeExtensionInterfaceFromJSON,
    EavDataAttributeExtensionInterfaceFromJSONTyped,
    EavDataAttributeExtensionInterfaceToJSON,
} from './EavDataAttributeExtensionInterface';
 ...
 */
export function instanceOfCatalogDataProductAttributeInterface(value: object): boolean {
    let isInstance = true;
...
export function CatalogDataProductAttributeInterfaceFromJSON(json: any): CatalogDataProductAttributeInterface {
    return CatalogDataProductAttributeInterfaceFromJSONTyped(json, false);
}

export function CatalogDataProductAttributeInterfaceFromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogDataProductAttributeInterface {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'extensionAttributes': !exists(json, 'extension_attributes') ? undefined : EavDataAttributeExtensionInterfaceFromJSON(json['extension_attributes']),
...
export function CatalogDataProductAttributeInterfaceToJSON(value?: CatalogDataProductAttributeInterface | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'extension_attributes': EavDataAttributeExtensionInterfaceToJSON(value.extensionAttributes),
