...
exports.CheckoutAgreementsCheckoutAgreementsListV1Api = void 0;
var runtime = __importStar(require("../runtime"));
var models_1 = require("../models");
/**
 *
 */
var CheckoutAgreementsCheckoutAgreementsListV1Api = /** @class */ (function (_super) {
    __extends(CheckoutAgreementsCheckoutAgreementsListV1Api, _super);
    function CheckoutAgreementsCheckoutAgreementsListV1Api() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * List of checkout agreements.
     */
    CheckoutAgreementsCheckoutAgreementsListV1Api.prototype.getV1CartsLicenceListRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return jsonValue.map(models_1.CheckoutAgreementsDataAgreementInterfaceFromJSON); })];
                }
            });
        });
    };
     ...
     * List of checkout agreements.
     */
    CheckoutAgreementsCheckoutAgreementsListV1Api.prototype.getV1CartsLicenceList = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1CartsLicenceListRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
    ...
    return CheckoutAgreementsCheckoutAgreementsListV1Api;
}(runtime.BaseAPI));
exports.CheckoutAgreementsCheckoutAgreementsListV1Api = CheckoutAgreementsCheckoutAgreementsListV1Api;
//# sourceMappingURL=CheckoutAgreementsCheckoutAgreementsListV1Api.js.map