...
exports.InventoryInStorePickupApiGetPickupLocationsV1Api = void 0;
var runtime = __importStar(require("../runtime"));
var models_1 = require("../models");
/**
 *
 */
var InventoryInStorePickupApiGetPickupLocationsV1Api = /** @class */ (function (_super) {
    __extends(InventoryInStorePickupApiGetPickupLocationsV1Api, _super);
    function InventoryInStorePickupApiGetPickupLocationsV1Api() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * Get Pickup Locations according to the results of filtration by Search Request.
     */
    InventoryInStorePickupApiGetPickupLocationsV1Api.prototype.getV1InventoryInstorepickupPickuplocationsRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.InventoryInStorePickupApiDataSearchResultInterfaceFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get Pickup Locations according to the results of filtration by Search Request.
     */
    InventoryInStorePickupApiGetPickupLocationsV1Api.prototype.getV1InventoryInstorepickupPickuplocations = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1InventoryInstorepickupPickuplocationsRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
    ...
    return InventoryInStorePickupApiGetPickupLocationsV1Api;
}(runtime.BaseAPI));
exports.InventoryInStorePickupApiGetPickupLocationsV1Api = InventoryInStorePickupApiGetPickupLocationsV1Api;
//# sourceMappingURL=InventoryInStorePickupApiGetPickupLocationsV1Api.js.map