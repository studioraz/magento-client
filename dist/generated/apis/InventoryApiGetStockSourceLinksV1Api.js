...
exports.InventoryApiGetStockSourceLinksV1Api = void 0;
var runtime = __importStar(require("../runtime"));
var models_1 = require("../models");
/**
 *
 */
var InventoryApiGetStockSourceLinksV1Api = /** @class */ (function (_super) {
    __extends(InventoryApiGetStockSourceLinksV1Api, _super);
    function InventoryApiGetStockSourceLinksV1Api() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * Find StockSourceLink list by given SearchCriteria
     */
    InventoryApiGetStockSourceLinksV1Api.prototype.getV1InventoryStocksourcelinksRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.InventoryApiDataStockSourceLinkSearchResultsInterfaceFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Find StockSourceLink list by given SearchCriteria
     */
    InventoryApiGetStockSourceLinksV1Api.prototype.getV1InventoryStocksourcelinks = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1InventoryStocksourcelinksRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
    ...
    return InventoryApiGetStockSourceLinksV1Api;
}(runtime.BaseAPI));
exports.InventoryApiGetStockSourceLinksV1Api = InventoryApiGetStockSourceLinksV1Api;
//# sourceMappingURL=InventoryApiGetStockSourceLinksV1Api.js.map