...
exports.InventoryApiSourceItemRepositoryV1Api = void 0;
var runtime = __importStar(require("../runtime"));
var models_1 = require("../models");
/**
 *
 */
var InventoryApiSourceItemRepositoryV1Api = /** @class */ (function (_super) {
    __extends(InventoryApiSourceItemRepositoryV1Api, _super);
    function InventoryApiSourceItemRepositoryV1Api() {
     ...
     */
    InventoryApiSourceItemRepositoryV1Api.prototype.getV1InventorySourceitemsRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.InventoryApiDataSourceItemSearchResultsInterfaceFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Find SourceItems by SearchCriteria We need to have this method for direct work with SourceItems because this object contains additional data like as qty, status (for example can be searchable by additional field)
     */
    InventoryApiSourceItemRepositoryV1Api.prototype.getV1InventorySourceitems = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1InventorySourceitemsRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
    ...
    return InventoryApiSourceItemRepositoryV1Api;
}(runtime.BaseAPI));
exports.InventoryApiSourceItemRepositoryV1Api = InventoryApiSourceItemRepositoryV1Api;
//# sourceMappingURL=InventoryApiSourceItemRepositoryV1Api.js.map