...
exports.AdobeStockAssetApiGetAssetListV1Api = void 0;
var runtime = __importStar(require("../runtime"));
var models_1 = require("../models");
/**
 *
 */
var AdobeStockAssetApiGetAssetListV1Api = /** @class */ (function (_super) {
    __extends(AdobeStockAssetApiGetAssetListV1Api, _super);
    function AdobeStockAssetApiGetAssetListV1Api() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * Search for images based on search criteria
     */
    AdobeStockAssetApiGetAssetListV1Api.prototype.getV1AdobestockAssetListRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.FrameworkSearchSearchResultInterfaceFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Search for images based on search criteria
     */
    AdobeStockAssetApiGetAssetListV1Api.prototype.getV1AdobestockAssetList = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1AdobestockAssetListRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
    ...
    return AdobeStockAssetApiGetAssetListV1Api;
}(runtime.BaseAPI));
exports.AdobeStockAssetApiGetAssetListV1Api = AdobeStockAssetApiGetAssetListV1Api;
//# sourceMappingURL=AdobeStockAssetApiGetAssetListV1Api.js.map