...
exports.CatalogCategoryListV1Api = void 0;
var runtime = __importStar(require("../runtime"));
var models_1 = require("../models");
/**
 *
 */
var CatalogCategoryListV1Api = /** @class */ (function (_super) {
    __extends(CatalogCategoryListV1Api, _super);
    function CatalogCategoryListV1Api() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * Get category list
     */
    CatalogCategoryListV1Api.prototype.getV1CategoriesListRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.CatalogDataCategorySearchResultsInterfaceFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get category list
     */
    CatalogCategoryListV1Api.prototype.getV1CategoriesList = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1CategoriesListRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
    ...
    return CatalogCategoryListV1Api;
}(runtime.BaseAPI));
exports.CatalogCategoryListV1Api = CatalogCategoryListV1Api;
//# sourceMappingURL=CatalogCategoryListV1Api.js.map