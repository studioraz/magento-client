...
exports.CatalogProductRenderListV1Api = void 0;
var runtime = __importStar(require("../runtime"));
var models_1 = require("../models");
/**
 *
 */
var CatalogProductRenderListV1Api = /** @class */ (function (_super) {
    __extends(CatalogProductRenderListV1Api, _super);
    function CatalogProductRenderListV1Api() {
     ...
     */
    CatalogProductRenderListV1Api.prototype.getV1ProductsrenderinfoRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.CatalogDataProductRenderSearchResultsInterfaceFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Collect and retrieve the list of product render info. This info contains raw prices and formatted prices, product name, stock status, store_id, etc.
     */
    CatalogProductRenderListV1Api.prototype.getV1Productsrenderinfo = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1ProductsrenderinfoRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
    ...
    return CatalogProductRenderListV1Api;
}(runtime.BaseAPI));
exports.CatalogProductRenderListV1Api = CatalogProductRenderListV1Api;
//# sourceMappingURL=CatalogProductRenderListV1Api.js.map