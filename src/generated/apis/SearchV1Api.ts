 ...
 * 
 */
export class SearchV1Api extends runtime.BaseAPI {

    /**
     * Make Full Text Search and return found Documents
     */
    async getV1SearchRaw(requestParameters: GetV1SearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FrameworkSearchSearchResultInterface>> {
     ...
     * Make Full Text Search and return found Documents
     */
    async getV1Search(requestParameters: GetV1SearchRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FrameworkSearchSearchResultInterface> {
        const response = await this.getV1SearchRaw(requestParameters, initOverrides);
