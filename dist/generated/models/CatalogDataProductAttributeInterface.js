...
exports.CatalogDataProductAttributeInterfaceToJSON = exports.CatalogDataProductAttributeInterfaceFromJSONTyped = exports.CatalogDataProductAttributeInterfaceFromJSON = exports.instanceOfCatalogDataProductAttributeInterface = void 0;
var runtime_1 = require("../runtime");
var EavDataAttributeExtensionInterface_1 = require("./EavDataAttributeExtensionInterface");
 ...
 */
function instanceOfCatalogDataProductAttributeInterface(value) {
    var isInstance = true;
...
exports.instanceOfCatalogDataProductAttributeInterface = instanceOfCatalogDataProductAttributeInterface;
function CatalogDataProductAttributeInterfaceFromJSON(json) {
    return CatalogDataProductAttributeInterfaceFromJSONTyped(json, false);
}
exports.CatalogDataProductAttributeInterfaceFromJSON = CatalogDataProductAttributeInterfaceFromJSON;
function CatalogDataProductAttributeInterfaceFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'extensionAttributes': !(0, runtime_1.exists)(json, 'extension_attributes') ? undefined : (0, EavDataAttributeExtensionInterface_1.EavDataAttributeExtensionInterfaceFromJSON)(json['extension_attributes']),
...
exports.CatalogDataProductAttributeInterfaceFromJSONTyped = CatalogDataProductAttributeInterfaceFromJSONTyped;
function CatalogDataProductAttributeInterfaceToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'extension_attributes': (0, EavDataAttributeExtensionInterface_1.EavDataAttributeExtensionInterfaceToJSON)(value.extensionAttributes),
...
exports.CatalogDataProductAttributeInterfaceToJSON = CatalogDataProductAttributeInterfaceToJSON;
//# sourceMappingURL=CatalogDataProductAttributeInterface.js.map