...
exports.CatalogCategoryAttributeRepositoryV1Api = void 0;
var runtime = __importStar(require("../runtime"));
var models_1 = require("../models");
/**
 *
 */
var CatalogCategoryAttributeRepositoryV1Api = /** @class */ (function (_super) {
    __extends(CatalogCategoryAttributeRepositoryV1Api, _super);
    function CatalogCategoryAttributeRepositoryV1Api() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * Retrieve all attributes for entity type
     */
    CatalogCategoryAttributeRepositoryV1Api.prototype.getV1CategoriesAttributesRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.CatalogDataCategoryAttributeSearchResultsInterfaceFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Retrieve all attributes for entity type
     */
    CatalogCategoryAttributeRepositoryV1Api.prototype.getV1CategoriesAttributes = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1CategoriesAttributesRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     */
    CatalogCategoryAttributeRepositoryV1Api.prototype.getV1CategoriesAttributesAttributeCodeRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, token, tokenString, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.request({
                            path: "/V1/categories/attributes/{attributeCode}".replace("{".concat("attributeCode", "}"), encodeURIComponent(String(requestParameters.attributeCode))),
                            method: 'GET',
                            headers: headerParameters,
                            query: queryParameters,
                        }, initOverrides)];
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.CatalogDataCategoryAttributeInterfaceFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Retrieve specific attribute
     */
    CatalogCategoryAttributeRepositoryV1Api.prototype.getV1CategoriesAttributesAttributeCode = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getV1CategoriesAttributesAttributeCodeRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
...
exports.CatalogCategoryAttributeRepositoryV1Api = CatalogCategoryAttributeRepositoryV1Api;
//# sourceMappingURL=CatalogCategoryAttributeRepositoryV1Api.js.map